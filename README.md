...
[openfairdb-x86_64-linux-v0.3.1.tar.gz](https://github.com/flosse/openfairdb/releases/download/v0.3.0/openfairdb-x86_64-linux-v0.3.1.tar.gz),
unpack and start it:

    wget https://github.com/flosse/openfairdb/releases/download/v0.3.1/openfairdb-x86_64-linux-v0.3.1.tar.gz
