...
mod tests {
    ...
    fn update_place_with_invalid_version() {
        ...
        let err = match prepare_updated_place(&mock_db, id, new, None, None, &accepted_licenses()) {
    ...
    fn update_non_existing_place() {
        ...
        let result = prepare_updated_place(&mock_db, id, new, None, None, &accepted_licenses());
    ...
    fn update_place_with_tags() {
        ...
        let storable =
            prepare_updated_place(&mock_db, id.clone(), new, None, None, &accepted_licenses())
                .unwrap();
        assert!(store_updated_place(&mock_db, storable).is_ok());
