...
[openfairdb-x86_64-linux-v0.3.4.tar.gz](https://github.com/flosse/openfairdb/releases/download/v0.3.4/openfairdb-x86_64-linux-v0.3.4.tar.gz),
unpack and start it:

    wget https://github.com/flosse/openfairdb/releases/download/v0.3.4/openfairdb-x86_64-linux-v0.3.4.tar.gz
    tar xzf openfairdb-x86_64-linux-v0.3.4.tar.gz
    ./openfairdb
