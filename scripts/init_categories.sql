-- Default set of categories as required by https://github.com/goodmap/goodmap-old
...
INSERT OR IGNORE INTO categories (id, created, version, name) VALUES ('77b3c33a92554bcf8e8c2c86cedd6f6f', strftime('%s', CURRENT_TIMESTAMP), 0, 'Business');
