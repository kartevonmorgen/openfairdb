...
[openfairdb_x86_64-unknown-linux-musl_v0.9.1.tar.xz](https://github.com/kartevonmorgen/openfairdb/releases/download/v0.9.1/openfairdb_x86_64-unknown-linux-musl_v0.9.1.tar.xz),
unpack and start it:

```sh
wget https://github.com/kartevonmorgen/openfairdb/releases/download/v0.9.1/openfairdb_x86_64-unknown-linux-musl_v0.9.1.tar.xz
tar xJf openfairdb_x86_64-unknown-linux-musl_v0.9.1.tar.xz
